...
Allows users to export data seamlessly to the AIS Data Store, enhancing integration with AIS infrastructure.
...
- Added icons for AIS Data Store and HTTP Model for better visual representation.
...
Feel free to adapt or expand this draft further to suit your documentation needs!