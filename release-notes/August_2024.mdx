...
### 🧠 **Databricks AI Model Connector**
Multiwoven now integrates seamlessly with [Databricks AI models](https://docs.squared.ai/guides/data-integration/sources/databricks-model). This connection allows users to activate AI models directly through Multiwoven, enhancing your data processing and analytical capabilities with cutting-edge AI tools.
...
Enhanced API support for catalog creation, streamlining workflows for developers and system integrators by automating catalog management.

### **Catalog Update API**
The catalog update API has been improved, enabling more seamless updates to existing catalogs, ensuring that your data is always current.

### **Databricks Model Connection Specification**
We corrected the connection specification for Databricks models, resulting in smoother and more reliable integrations with Databricks.
...
### **Server Gem Updates**
Upgraded server gems to versions `0.5.2` and `0.6.0`, resulting in improved performance, stability, and security.
...
### **Databricks Datawarehouse Name Change**
...
### **Integration Gem Update**
Updated the integration gem to version `0.7.1`, bringing in enhanced features, performance improvements, and bug fixes.
