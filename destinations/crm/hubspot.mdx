...
<Accordion title="Create a Private App" icon="lock">
  For Multiwoven Open Source, we hubspot Private App Access Token for api authentication.
  ...
  <Steps>
    ...
    <Step title="Utilize the App">
      Once created, you can leverage the access token to setup hubspot in Multiwoven destination section.
    </Step>
