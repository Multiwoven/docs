...
<CardGroup cols={3}>
  ...
  <Card title="AI & Data Integration" icon="code-simple" href="/guides">
    Connect to AI/ML models, databases, and business data sources.
  </Card>
  <Card title="Embedding AI" icon="github" iconType="solid" href="/open-source">
  ...
  <Card title="Support & FAQs" icon="bug" href="/troubleshooting">
