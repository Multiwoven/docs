...
title: "SFTP"
<<<<<<< HEAD
description: "Learn how to set up a SFTP destination connector in AI Squared to efficiently transfer data to your SFTP server."
=======
