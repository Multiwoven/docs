...
[![Star us on GitHub](https://img.shields.io/github/stars/Multiwoven/multiwoven?style=for-the-badge&label=Star%20us%20on%20GitHub
...
**[Stream](https://github.com/Multiwoven/multiwoven-integrations/blob/6462867b1a2698b4c30ae5abcdf3219a207a28d9/lib/multiwoven/integrations/protocol/protocol.rb#L105
)** - A Stream defines the structure and metadata of a resource, such as a database table, REST API resource, or data stream, outlining how users can interact with it using query or request.
...
<Note> Rate limit specified in catalog will applied to stream if there is no stream specific rate limit is defined. </Note>
