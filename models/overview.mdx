...
Creating a model in Multiwoven involves a series of steps designed to streamline the organization of your data for efficient querying. This overview will guide you through each step of the process.

### Step 1: Navigate to the Models Section

To start defining a model:

1. Access the Multiwoven dashboard.
2. Look for the "Define" menu on the sidebar and click on the `Models` section.

*Placeholder for screenshot: Navigating to Models Section*

### Step 2: Add a New Model

Within the Models section:

1. Click on the `Add Model` button to initiate the model creation process.

<img
  className="block"
  src="https://res.cloudinary.com/dspflukeu/image/upload/v1708066240/Multiwoven/Docs/models/image_5_ud7q2w.png"
  alt="Hero Light"
/>
...
1. Adding a name and a brief description for your model. This helps in identifying and managing your models within Multiwoven.
...
After completing these steps, your model will be set up and ready to use in Multiwoven.
