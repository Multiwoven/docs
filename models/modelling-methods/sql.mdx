...
### Model Preview 
- For saving a query expected to return results later, refer to the section on 'Saving a Model with Future Data'.
...
- Optionally, organizing your model within a specific folder.
...
- Remember to initiate a full resync if the primary key is altered.
